...
?>
    ...
    <div class="paragraph1">
      <h1>OUR TEAM</h1>
      <h3><p>Foodshala was founded in 2020. We care about quality, craft and disciplined experimentation. We are active contributors to open source software.</p><p> We help innovate, develop and pioneer. </p></h3>
    </div>
    ...
    <div class="col-md-10" style="float: none; margin: 0 auto;">
        <div class="paragraph2">
          ...
          <div class="goldcolor">
            ...
            <h3>You hired Foodshala, and now we're one team with a shared mission. Let's figure it our together.</h3>
          </p>
          <p><br>
          <div class="goldcolor">
